...
**Companion handoffs:**
- `docs/handoffs/2026-05-21-strong-pi-server-patch.md` — strong-Π + `chat_parser=epsilon` workaround (separate workstream)
- `docs/handoffs/2026-05-20-ima-embedrow-transformer-investigation.md` — prior diagnosis ("broken-attack" reading from the residual-MLP era)
