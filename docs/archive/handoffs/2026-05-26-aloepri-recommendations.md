...
created: 2026-05-26
updated: 2026-05-26
tags: [aloepri, aloepri, alg2]
companion: [aloepri-attacks]
archive_reason: "AloePri deployment recommendations extracted from aloepri-attacks.md so the attacks doc stays a pure measurement reference. Recommendations apply to the 2026-05-26 paper-literal Alg2 migration decision."
---

# Handoff — AloePri aloepri deployment recommendations (2026-05-26)

> Extracted from `docs/research/aloepri-attacks.md` §"Implications for aloepri".
...
4. **A different threat-model reading.** The aloepri score-surface attack we previously characterised as "AloePri provides ~0 pp defense" was a measurement of the *anti-defense version* of Alg2 we'd deployed. Real AloePri Alg2 (paper-literal) defends meaningfully on this surface too. The remaining 6-7 % obf TTRSR at L≥5 is the operational leak budget, not 47 %.
