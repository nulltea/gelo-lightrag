...
**The detailed handoff is `docs/dev/prototype/aloepri-attack-harness.md`**
...
2. **Read** `docs/research/aloepri-vs-gelo.md` §4 then
   `docs/dev/prototype/aloepri-attack-harness.md` end to end.
...
5. **Drive Phase 2 acceptance on Qwen3-1.7B**, not Gemma 4 — the
   ...
   `docs/archive/handoffs/2026-05-18-gemma4-architecture-support.md`).
...
- `docs/dev/prototype/aloepri-attack-harness.md` (new — the Phase 2/3
  handoff)
