...
companion: [2026-05-19-m2-7-attack-findings, 2026-05-19-option-c-m2-7-rerun-findings]
---
...
`docs/archive/handoffs/2026-05-19-alg2-z-block-degeneracy.md`.
...
1. **Refresh the M2.7 ledger** in
   `docs/archive/handoffs/2026-05-19-m2-7-attack-findings.md` with the
