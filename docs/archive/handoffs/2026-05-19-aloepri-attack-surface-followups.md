...
superseded_by: 2026-05-20-aloepri-attacks-status-and-paired-data-defences
archive_reason: "threads 1-3 superseded; threads 4+ retained for context"
---

# Handoff — AloePri attack-surface followups + Algorithm 1 sweep + GELO-like dynamic defence + Gram leakage

> **Note:** Threads 1–3 are superseded by
> [`2026-05-20-aloepri-attacks-status-and-paired-data-defences.md`](2026-05-20-aloepri-attacks-status-and-paired-data-defences.md).
> Threads 4+ retained below for context.
...
`docs/dev/prototype/aloepri-qk-norm-matrix-gamma-threat-model.md`.
...
`docs/dev/prototype/aloepri-qk-norm-matrix-gamma-threat-model.md` and
...
- `docs/archive/handoffs/2026-05-19-alg2-qwen3-shape-analysis.md` (updated
  §4a with Option B verdict).
- `docs/archive/handoffs/2026-05-19-alg2-z-block-degeneracy.md` — task #9
  finding.
- `docs/archive/handoffs/2026-05-19-option-c-m2-7-rerun-findings.md` —
  Option C re-measure ledger.
- `docs/archive/handoffs/2026-05-19-option-c-steps-0-1-2a-findings.md` —
  full step 0-1-2a ledger.
- `docs/archive/handoffs/2026-05-19-m2-7-attack-findings.md` (updated with
