...
- **IMA-EmbedRow-transformer driver fix** — tracked separately; conceptual plan in `docs/research/aloepri-attacks.md`, optimizer diagnosis in `docs/archive/handoffs/2026-05-20-ima-embedrow-transformer-investigation.md`.
