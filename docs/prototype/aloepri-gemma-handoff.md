...
> - Running status: [`../plans/path-2-status.md`](../plans/path-2-status.md)
...
[`../plans/path-2-status.md`](../plans/path-2-status.md). This
...
`docs/plans/path-2-status.md` for the chronological account.*
