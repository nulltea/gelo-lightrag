...
created: 2026-05-19
updated: 2026-05-19
tags: [aloepri, threat-model, qwen3]
---
...
`docs/dev/prototype/gelo-llm.md` and memory `gelo_research_round_2.md`).
...
- `docs/archive/handoffs/2026-05-19-alg2-qwen3-shape-analysis.md` —
  γ-iso-tonic measurement, §4a verdict.
- `docs/archive/handoffs/2026-05-19-m2-7-attack-findings.md` — M2.7 attack
