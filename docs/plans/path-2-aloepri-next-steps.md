...
>
> - Plan: [`path-2-aloepri-gemma.md`](path-2-aloepri-gemma.md)
> - Running status (chronological): [`path-2-status.md`](path-2-status.md)
> - Protocol doc: [`../prototype/aloepri-llm.html`](../prototype/aloepri-llm.html)
> - Gemma 4 deferred work: [`../prototype/aloepri-gemma-handoff.md`](../prototype/aloepri-gemma-handoff.md)
